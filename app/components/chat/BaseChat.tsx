            ...
            {!chatStarted && (
              <div id="intro" className="mt-[16vh] max-w-chat mx-auto text-center px-4 lg:px-0">
                <div className="flex items-center justify-center">
                  <img src="/logo-light.png" alt="NST-SDC Light Logo" className="h-30 dark:hidden" />
                  <img src="/logo-dark.png" alt="NST-SDC Dark Logo" className="h-30 hidden dark:block" />
                </div>
                ...
                >
                  ...
                  >
                    <textarea
                      ...
                      placeholder="How can NST-SDC.dev help you today?"
                      translate="no"
                    />
                    <ClientOnly>
                      {() => (
